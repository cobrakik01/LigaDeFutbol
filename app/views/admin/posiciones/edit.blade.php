...
{{ Form::model($posicione, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('admin.posiciones.update', $posicione->nombre_posicion))) }}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              {{ Form::text('nombre_posicion', Input::old('nombre_posicion'), array('class'=>'form-control', 'placeholder'=>'Posicion')) }}
            </div>
        </div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('admin.posiciones.show', 'Cancelar', $posicione->nombre_posicion, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
